/*
 ...
 MyFonts Webfont Build ID 2797740, 2014-04-19T12:20:45-0400
...
for(var fonts=[{fontFamily:"BodoniBT-Book",url:wfpath+"2AB0AC_0"+suffix+"_0."+webfontType},{fontFamily:"BodoniBT-BookItalic",url:wfpath+"2AB0AC_1"+suffix+"_0."+webfontType},{fontFamily:"BodoniBT-Roman",url:wfpath+"2AB0AC_2"+suffix+"_0."+webfontType},{fontFamily:"BodoniBT-Italic",url:wfpath+"2AB0AC_3"+suffix+"_0."+webfontType}],len=fonts.length,css="",i=0;i<len;i++){var format="svg#wf"==webfontType?'format("svg")':"ttf"==webfontType?'format("truetype")':"eot"==webfontType?"":'format("'+webfontType+
